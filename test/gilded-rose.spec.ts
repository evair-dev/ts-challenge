...
import { Item, GildedRose } from '../app/solution-02/gilded-rose';
...
describe('Gilded Rose', function () {
    ...
    describe('#tick', function () {
        ...
        context('GeneralItem', function () {

            it('updates general items before sell date', function () {
                const gildedRose = new GildedRose([ new Item('general', 10, 5)]);
            ...
            it('does not decrease quality below zero', function () {
                const gildedRose = new GildedRose([ new Item('general', 10, 0)]);
            ...
            it('decreases quality twice as fast after sell date', function () {
                const gildedRose = new GildedRose([ new Item('general', 10, 0)]);
            ...
            it('does not decrease quality below zero even after sell date', function () {
                const gildedRose = new GildedRose([ new Item('general', 0, 0)]);
